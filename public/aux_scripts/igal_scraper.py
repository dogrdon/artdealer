...
'''
scaperwiki script (https://classic.scraperwiki.com/scrapers/igal-m-atelier/) for gaining the records from the original site (http://igalcalderpicassowarhol.com)

should be run inside scraperwiki, or you will need the scraperwiki module, but that probabably would need tweaking to output to a table. 

TODO: modify to output in a more streamlined way, take a step or two out of the workflow.
'''
